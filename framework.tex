...
or the full-split local-code inner of Section~\ref{sec:structured-local-code}),
...
and the structured full-split inner used in the finite certificate (Section~\ref{sec:structured-local-code}).
...
(accumulator; dense time-varying recursion; full-split local-code recursion).
\end{itemize}
