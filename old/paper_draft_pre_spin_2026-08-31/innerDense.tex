% ARCHIVAL SOURCE.
% This monolithic dense-inner workspace is preserved for provenance and
% exploration history. The compiled theorem-facing dense inner section is
% innerDenseScalar.tex; active exploratory material lives under explorations/.
...
the original dense-inner workspace; theorem-facing material has been extracted
to \texttt{innerDenseScalar.tex}, and non-main refinements have been preserved
under \texttt{explorations/}.
...
\(-37.278528\), while the BCH rows are marked heuristic in both outputs.  The modeled BCH local spectrum is
\[
...
\(+10,+20,+40\) bits are \(65.625088\), \(55.894300\), and \(35.894577\) bits, respectively.  Thus the projection
