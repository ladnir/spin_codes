...
and \texttt{-march=znver4}. Each cell is the median of three
...
The BAA rows use the newer chosen-block Golay and RM implementations
\cite{cryptoeprint:2026/1903}, rather than the original BAA implementation
\cite{KolesnikovEtAl2026BA}. Their message lengths are $2^m-64$ for
