...
encoders use $O(N)$ bit operations. With probability $1-o(1)$ over setup, its
  ...
  interleaver into structured routing stages, and uses an Independent-Map
  Transvection (IMT) inner. The outer interface permits different base constituents and base
...
uses a fixed BCH-derived $[256,128,\ge38]$ constituent and the same IMT inner
...
the batched transposed encoder at $K=2^{20}$ in $10.110$\,ms.\footnote{This work was created with the assistance of ChatGPT 5.6, 6.0.}
\end{abstract}
