...
Figure~\ref{fig:flock-projection} also considers replacing the PCS with
...
$244$ and $1060$\,ms, compared with the measured SPIN totals of $112$
and $413$\,ms. Thus the projected Bolt configuration remains slower even
...
\begin{figure}[tb]
\centering
\input{figures/flock_projection}
\caption{Measured Flock prover times and an optimistic Bolt--Flock
projection, at $32$ and $128$\,MiB of witness data. Hatched bars combine
measured components and work proxies; they assume free claim conversion,
shared opening work, and the amortized limit for the matrix proof.
Bolt--Flock is not implemented, and the projection is not a runtime bound.}
\label{fig:flock-projection}
\end{figure}
