...
Fix lengths $K,N\ge1$. The construction independently samples an outer
encoder $O:\F_2^K\to\F_2^N$, a permutation $\Pi$ of $[N]$, and a linear
inner encoder $I:\F_2^N\to\F_2^N$. Fixed components are deterministic
choices. The realized SPIN encoder is $E:=I\circ\Pi\circ O$.
