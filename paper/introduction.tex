...
SPIN follows the serial-concatenation pattern. An outer encoder
...
We also test whether these encoding properties improve a complete prover.
We instantiate Brakedown's matrix polynomial commitment scheme (PCS)
with SPIN, then integrate that PCS into Flock. Separate measurements
of ordinary encoding, standalone commitment and opening, and complete
constraint proving connect the code's cost to its application-level benefit.
The resulting PCS favors prover speed over proof size.
