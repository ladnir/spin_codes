...
\begin{itemize}
  ...
  With termination, SPIN also answers the question of Bazzi, Mahdian, and
  Spielman~\cite{bms09} about logarithmic outer memory and one interleaver
  (Section~\ref{sec:bms-question}).
