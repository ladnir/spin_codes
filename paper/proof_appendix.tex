\section{Proof details and artifact interfaces}

This appendix records proof details that are not needed to understand the
construction progression.

\subsection{Random SPIN exponent closure}
...
The hash-bound artifact named in
Appendix~\ref{app:structured-scalable-certificate} contains the complete
structured-route and RM2Sub transfer derivations, verifier sources, receipts,
and arithmetic semantics. The theorem uses the probability space and
inequalities stated in the main text and appendices; the artifact supplies the
independently checkable arithmetic witnesses.
