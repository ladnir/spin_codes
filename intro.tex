...
Section~\ref{sec:structured-local-code} develops the structured local-code certificate interface and the current
RM/EBCH finite checkpoint.  Sparse, expander-accumulator, block-recursive BCH, and BCH-spectrum explorations are preserved
outside the main spine for later refinement.
