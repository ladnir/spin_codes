...
entirely dominated by the \(e\ge1\) branch; the \(e=0\) branch contributes \(-136323.731114\).  This strongly suggests
that the final early high-density proof should be organized as an endpoint-dominance lemma in \(T\) plus an exact
hypergeometric first-block \(r\)-sum or \(r\)-tail bound.
...
interval table above.  The reported combined finite late-window contribution is unchanged:
\[
