...
The exact RM direct-sum support gives a sharper and cleaner finite certificate.  Computing the truncated coefficients of
the local RM spectrum to \(h\le500\) shows that the positive support begins
\[
32,\ 48,\ 56,\ 60,\ 64,\ldots,
\]
so the apparent adjacent \(h=33,34,\ldots\) ridge is a Cauchy-smoothing artifact.  Reweighting the same audited
...
\]
with the \(h=32\) slice alone contributing \(-37.383482\) and all \(h>32\) support contributing only \(-50.738253\).
The exact ultra-late prefix is
\[
\log_2\mu_{32\le h\le500,\ T<5949}^{\rm exact\ outer}\le -41.113442,
\]
and the combined finite ledger becomes
\[
