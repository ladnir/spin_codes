...
\(-132649.521954\), only \(0.003191\) bits above the endpoint peak.  This strongly suggests that the final early
high-density proof should be organized as an endpoint-dominance lemma in \(T\) plus an exact hypergeometric
first-block \(r\)-tail bound.
