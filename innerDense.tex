...
\(1.484774\)-bit turnoff adjustment.  The seventh row is the complement-side high-density table, checked as a
contiguous \(1048577,\ldots,N\) cover.  The last two row families overlap on \(1048577\le h\le1148736\); the ledger
records this overlap and deliberately keeps it as harmless union-bound overcount.  Therefore the combined contribution
is bounded by
\[
\begin{aligned}
