...
\begin{proof}
The first row is the tracked \(501\le h\le2000\) all-episode h-summary artifact.  The second row is the fixed-pole
interval table through the feasible far-bucket cutoff \(h=1148736\).  The third row is the complement-side high-density
table.  The last two row families overlap on \(1048577\le h\le1148736\); the ledger deliberately keeps this harmless
overcount as a union bound.  Therefore the combined contribution is bounded by
\[
\log_2\!\left(2^{-182.259739}+2^{-586.597103}+2^{-35150.097366}\right)\le -182.259739.
\]
...
interval tables above, including the complement-side high-density manifest.  Reweighting the \(h\le500\) pieces by exact
...
late-window ledger is below \(-182.259739\) bits.  Including the checked exact-outer ultra-late placement prefix, the
