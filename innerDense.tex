...
\end{array}
\]
Thus the analytic replacement should prove these two component slope bounds, or a direct product bound, rather than
re-summing all \(469\) ridge rows.
The standard verifier
\[
\texttt{python scripts/verify\_fullsplit\_finite\_ledger.py}
\]
also checks this ratio skeleton directly.
