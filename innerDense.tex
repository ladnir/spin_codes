...
\(T\approx5949\), nor the small-weight early slice.  The checked endpoint early rows now also cover
\[
501\le h\le75000,\qquad T>17948,
\]
with total \(-380.829185\) bits.  The remaining first-active coverage is the early middle/high range
\(75001\le h\le N/2\), together with the post-prefix part of the ultra-late cap.
...
the checked early endpoint table for \(T>17948\) through \(h=75000\).  The third row is the fixed-pole interval table
through the feasible far-bucket cutoff \(h=1148736\).  The fourth row is the complement-side high-density table.  The
last two row families overlap on \(1048577\le h\le1148736\); the ledger deliberately keeps this harmless overcount as a
union bound.  Therefore the combined contribution is bounded by
\[
\log_2\!\left(2^{-182.259739}+2^{-380.829185}+2^{-586.597103}+2^{-35150.097366}\right)\le -182.259739.
\]
...
early endpoint rows through \(h=75000\), and the fixed-pole interval tables above, including the complement-side
high-density manifest.  Reweighting the \(h\le500\) pieces by exact
