...
\text{early} & T>17948 & \text{not yet part of this finite certificate.}
\end{array}
\]
...
\]
The proof debt is therefore no longer the boundary slice \(T\approx5949\); it is the remaining first-active coverage,
namely the early region \(T>17948\) and the post-prefix part of the ultra-late cap.
