...
def main():
    ...
    for row in sparse:
        ...
        rows.append(result)
    path = HERE/'bch_engineering_evidence_v5.csv'
    ...
    fig.savefig(HERE/'bch_q1_vs_dense_tradeoff_v5.png', dpi=180)
    plt.close(fig)
    ...
    fig.savefig(HERE/'bch_full_bound_coverage_v5.png', dpi=180)
    plt.close(fig)
    model_checks = []
    ...
    fig.savefig(HERE/'bch_full_bound_k_scaling_v5.png', dpi=180)
    plt.close(fig)
    ...
    (HERE/'bch_engineering_evidence_v5.json').write_text(json.dumps(summary, indent=2)+'\n')
    ...
    (HERE/'bch_k_counting_model_v1.json').write_text(json.dumps(model, indent=2)+'\n')
