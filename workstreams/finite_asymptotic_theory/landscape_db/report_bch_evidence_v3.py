...
def main():
    ...
    for row in sparse:
        ...
        rows.append(result)
    path = HERE/'bch_engineering_evidence_v3.csv'
    ...
    fig.savefig(HERE/'bch_q1_vs_dense_tradeoff_v3.png', dpi=180)
    plt.close(fig)
    ...
    fig.savefig(HERE/'bch_full_bound_coverage_v3.png', dpi=180)
    plt.close(fig)
    ...
    (HERE/'bch_engineering_evidence_v3.json').write_text(json.dumps(summary, indent=2)+'\n')
