...
The exact legacy root-level TeX draft was moved to
old/paper_draft_pre_spin_2026-08-31/. The directory contains all 20 former
root-level TeX files. ARCHIVE_MANIFEST.md records their byte lengths and
SHA-256 hashes after the move. No construction directory, frozen source,
receipt, subdirectory paper, or planning document was moved.
