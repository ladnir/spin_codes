"""Replay joint-tuned or hybrid IMT covers and their exact integer partitions."""
import argparse
import json
import math
...
import numpy as np
import parameter_joint_dense as producer
...
def verify(path,output):
    ...
    if saved['status'] == 'BINARY64_IMT_JOINT_DENSE_COVER':
        cls = producer.Dense
    else:
        assert saved['status'] == 'BINARY64_IMT_HYBRID_DENSE_COVER'
        import parameter_hybrid_dense
        cls = parameter_hybrid_dense.Dense
