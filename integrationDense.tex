...
It deliberately omits the finite scalar diagnostics and working-save-point calculations, which are preserved in
\texttt{explorations/scalar\_dense\_finite\_diagnostics.tex}.  The proof here is a direct first-moment argument: the outer
contributes an expected spectrum envelope, while the inner contributes a low/intermediate-weight contraction and a
linear-weight large-deviation tail.
