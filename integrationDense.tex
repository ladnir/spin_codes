...
Theorem~\ref{thm:dense-dense-integration} is the qualitative dense+dense theorem: the systematic outer removes collapse
to tiny intermediate weights, the outer contributes a global geometric spectrum envelope, and the inner handles small
weights by the run-aware bound and larger weights by a geometric cutoff.  Baseline parameter corollaries and
memory-scaling interpretations are preserved in the scalar dense diagnostics note; the next main-step proof uses a
sharper linear-weight exponent comparison.
