"""One bounded, sequential exact-LP attempt, retaining its complete log."""
import subprocess
import time
...
command=['wsl.exe','-d','Ubuntu-24.04','--cd',
    '/mnt/c/Users/peter/.codex/worktrees/ba80/permute_conv/bch_spectrum_work/bch_spectrum_codex_bundle/generated/oa21_hull_probe',
    '--','env','LD_LIBRARY_PATH=../oa21_closure_probe/tools/runtime/usr/lib/x86_64-linux-gnu',
    '../oa21_closure_probe/tools/runtime/usr/bin/esolver','-S','-d','7','-P','256','-L','-R','60',
