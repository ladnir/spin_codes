...
Appendix~\ref{sec:accumulator-spin}.

\subsubsection{Relation to Silver and Expand-Convolute}
...
\subsubsection{Random Recursive Inner}
...
\subsubsection{Exact Convolution Transfer}
...
\subsubsection{Random-Family Encoding Costs}
