...
SELECT
    ...
    r.dominant_weight,
    r.dominant_second_weight,
    r.dominant_log_surprisal,
    r.dominant_witness_at_grid_edge,
    r.comparison_eligible,
    r.setup_event_id,
    r.setup_failure_bits,
    r.witness_shift,
