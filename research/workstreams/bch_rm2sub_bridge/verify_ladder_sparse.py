"""Search-independent sparse replay for the selected (128,19) ladder."""
import argparse
from pathlib import Path
import certificate_search_core as core
import ladder_sparse_backend as backend
...
def verify_report(path,fresh=False):
    ...
    core.require(spec==identity.instance(spec['message_exponent']),'Wrong report instance')
