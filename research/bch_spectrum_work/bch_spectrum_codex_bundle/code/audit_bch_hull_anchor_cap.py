"""Exact primal/dual check of the hull model with its derived spectrum anchor."""
import json
import sys
...
from prepare_bch_hull_anchor_probe import build as model_build
...
GEN=ROOT/'generated'
FOLDER=GEN/'oa21_hull_anchor_probe'
...
def build():
    ...
    previous=json.loads((GEN/'oa21_hull_probe/audit.json').read_text())
    ...
    paths=[Path(__file__),ROOT/'code/prepare_bch_hull_anchor_probe.py',ROOT/'code/prepare_bch_hull_probe.py',
           GEN/'oa21_hull_probe/audit.json',GEN/'bch256_q1_activity_cells_outward.json',
           GEN/'bch256_q1_full_arb_transfer.json',FOLDER/'model.json',FOLDER/'scales.json',
           FOLDER/'h_38.lp',FOLDER/'h_38.sol']
    return dict(classification='Exact hull LP certificate with derived dimension-69 anchor',
