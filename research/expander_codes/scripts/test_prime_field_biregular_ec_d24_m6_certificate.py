...
from prime_field_biregular_ec_d24_m6_certificate import (
    BLOCKS,
    EXACT_BANDS,
    K,
)
...
class PrimeFieldBiregularECD24M6CertificateTests(unittest.TestCase):
    def test_partition_covers_every_nonzero_support(self) -> None:
        certificate = {
            "parameters": {"k": K},
            "exact_bands": [
                {"lo": lo, "hi": hi} for lo, hi in EXACT_BANDS
            ],
