% ARCHIVAL SOURCE.
% This monolithic integration workspace is preserved for provenance and
% exploration history. The compiled theorem-facing dense integration section is
% integrationDense.tex; finite diagnostics and spectrum explorations live under
% explorations/.
...
This file is not part of the current compiled paper spine. It is retained as
the original dense-integration workspace; theorem-facing material has been
extracted to \texttt{integrationDense.tex}, and finite diagnostics/projections
have been preserved under \texttt{explorations/}.
