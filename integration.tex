...
the worst observed adjacent log-ratio through \(h=2000\) is below \(-0.36\) bits.  This is not used as a theorem yet,
but it gives the right target for the final h-block certificate: prove a uniform geometric domination beyond a finite
prefix, then add the negligible residual to the displayed break-even sum.
