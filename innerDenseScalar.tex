...
The scalar dense-inner refinement note preserves the polynomial-prefactor variant and OFF-term bookkeeping.  The
constant-factor envelope above is the version consumed by the dense+dense integration theorem.
